...
import SelectOptionSearchGuru from "@/Components/SelectOptionSearchGuru";
                    ...
                    <div className="card h-full shadow mb-4">
                        ...
                        <div className="relative overflow-x-auto mt-3 mb-4 ">
                            ...
                            >
                                ...
                                <SelectOptionSearchGuru
                                    guru={guru}
                                    onChange={(id) => setData("id_guru", id)}
                                />
                                <InputError
                                    message={errors.id_guru ?? ""}
                                    className="mt-2"
                                />
