   ...
   return (
         <div className="header">
            ...
            <nav className="bg-white px-6 py-[10px] flex items-center justify-between shadow-sm">
               <button id="nav-toggle" className="text-gray-800">
               ...
               <ul className="flex ml-auto items-center">
                     ...
                     <div className="dropdown-menu dropdown-menu-lg lg:left-auto lg:right-0" aria-labelledby="dropdownNotification">
                        <div>
                           ...
                           <div className="border-top px-3 py-2 text-center">
                              <a href="#" className="text-gray-800 font-semibold">View all Notifications</a>
                           </div>
                        </div>
                     </div>
                  </li> */}
                  ...
                  <li className="dropdown ml-2">
                     <a className="rounded-full" href="#" role="button" id="dropdownUser" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div className="w-10 h-10 relative">
                           <img alt="avatar" src={Avatar1} className="rounded-full" />
                           <div className="absolute border-gray-200 border-2 rounded-full right-0 bottom-0 bg-green-600 h-3 w-3"></div>
                        </div>
                     </a>
                     <div className="dropdown-menu dropdown-menu-start p-1" aria-labelledby="dropdownUser">
                        ...
                        <ul className="list-unstyled">
                           {/* <li>
                              <a className="dropdown-item" href="#">
                                 <i className="w-4 h-4" data-feather="user"></i>
                                 Edit Profile
                              </a>
                           </li>
                           <li>
                              <a className="dropdown-item" href="#">
                                 <i className="w-4 h-4" data-feather="activity"></i>
                                 Activity Log
                              </a>
                           </li>
                           ...
                           <li>
                              <a className="dropdown-item" href="#">
                                 <i className="w-4 h-4" data-feather="star"></i>
                                 Go Pro
                              </a>
                           </li>
                           <li>
                              <a className="dropdown-item" href="#">
                                 <i className="w-4 h-4" data-feather="settings"></i>
                                 Account Settings
                              </a>
                           </li> */}
                           {
                              ...
                              ? 
                                 <li>
                                    <Link className="dropdown-item" href={route('rekap-guru.index')}>
                                       <i className="w-4 h-4" data-feather="settings"></i>
                                       Rekap Absen Saya
                                    </Link>
                                 </li> 
                           ...
                           <li>
                              <button className="dropdown-item" onClick={logout}>
                                 <i className="w-4 h-4" data-feather="power"></i>
                                 Sign Out
                              </button>
                           </li>
                        </ul>
